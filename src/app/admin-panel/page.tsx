...
// type MainCategoryOptions = {
// }

// const mainCategoryOptions: MainCategoryOptions ={
...
// // 🧰 Tech Stack options (you can expand as needed)
// const techStackOptions: string[] = [
//   "React",
//   "Vue",
//   "Angular",
...
// // ⭐ Rating options (e.g., for profile rating)
...
//       if (filters.profile_rating) {
//         query = query.eq("profile_rating", filters.profile_rating);
//       }
...
//       const { data, error } = await query
//         .range(0, 2000) // fetch more rows than 100
//         .order("created_at", { ascending: false });
...
//                 {/* Send Email Section */}
//                 {freelancers.length > 0 && (
//                   <motion.div className="mt-12 bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8">
//                     <div className="flex items-center gap-3 mb-6">
//                       <div className="w-10 h-10 bg-[#FFE01B]/20 rounded-xl flex items-center justify-center border border-[#FFE01B]/30">
//                         <Mail className="w-5 h-5 text-[#FFE01B]" />
//                       </div>
