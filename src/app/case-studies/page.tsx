            ...
            <div className="flex flex-col lg:flex-row gap-6 items-center">
              ...
              <motion.div className="relative flex-1" initial="hidden" animate="visible" variants={fadeInLeft}>
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-[#FFE01B] transition-colors duration-300"
                />
              </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {filteredStudies.map((study, index) => (
                <motion.div
                  ...
                  className="group relative bg-white/5 backdrop-blur-sm rounded-3xl overflow-hidden border border-white/10 hover:border-[#FFE01B]/50 transition-all duration-500"
                ...
                >
                  ...
                  <div className="relative p-6 space-y-4">
                    ...
                    <h2 className="text-xl font-bold text-white group-hover:text-[#FFE01B] transition-colors duration-300 line-clamp-2">
                      {study.title}
                    </h2>
