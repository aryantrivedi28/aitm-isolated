...
export default function Header() {
  ...
  return (
    <div className="fixed top-4 left-1/2 -translate-x-1/2 w-[95%] sm:w-[90%] max-w-7xl bg-white/20 backdrop-blur-md border border-white/20 shadow-lg shadow-black/20 rounded-lg z-50">
